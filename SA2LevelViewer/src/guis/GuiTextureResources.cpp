...
//GuiTexture* GuiTextureResources::textureCursor3D = nullptr;
...
void GuiTextureResources::loadGuiTextures()
{
    ...
    //INCR_NEW("GuiTexture") textureCursor3D = new GuiTexture(Loader::loadTextureNoInterpolation(Global::dirProgRoot + "res/Images/Cursor3D.png"), 0.5f, 0.5f, 64*px, 64*py, 0);
}
