...
void SPRB::loadStaticModels()
{
    ...
    loadModel(&SPRB::models, Global::dirProgRoot + "res/Models/GlobalObjects/Spring/", "SpringB");

    if (SPRB::cmBase == nullptr)
    {
        SPRB::cmBase = loadCollisionModel(Global::dirProgRoot + "res/Models/GlobalObjects/Spring/", "SpringB");
    }
}
