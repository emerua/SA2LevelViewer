...
void KNUDAI::loadStaticModels()
{
    ...
    loadModel(&KNUDAI::models, Global::dirProgRoot + "res/Models/GlobalObjects/Knudai/", "Knudai");

    if (KNUDAI::cmBase == nullptr)
    {
        KNUDAI::cmBase = loadCollisionModel(Global::dirProgRoot + "res/Models/GlobalObjects/Knudai/", "Knudai");
    }
}
