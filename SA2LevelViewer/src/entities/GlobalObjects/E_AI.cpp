...
std::list<TexturedModel*> E_AI::models;
CollisionModel* E_AI::cmBase = nullptr;
...
E_AI::E_AI(char data[32], bool useDefaultValues)
{
...
void E_AI::loadStaticModels()
{
    ...
    loadModel(&E_AI::models, Global::dirProgRoot + "res/Models/GlobalObjects/Hunter/", "Hunter");

    if (E_AI::cmBase == nullptr)
    {
        E_AI::cmBase = loadCollisionModel(Global::dirProgRoot + "res/Models/GlobalObjects/Hunter/", "Hunter");
    }
}
...
void E_AI::updateValue(int btnIndex)
{
    char buf[128];
    std::string text = buf;
...
void E_AI::fillData(char data[32])
{
    data[1] = (char)ID;
