...
void SPRA::loadStaticModels()
{
    ...
    loadModel(&SPRA::models, Global::dirProgRoot + "res/Models/GlobalObjects/Spring/", "SpringA");

    if (SPRA::cmBase == nullptr)
    {
        SPRA::cmBase = loadCollisionModel(Global::dirProgRoot + "res/Models/GlobalObjects/Spring/", "SpringA");
    }
}
