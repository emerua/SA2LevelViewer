...
SG_SPRA::SG_SPRA(char data[32], bool useDefaultValues)
{
...
void SG_SPRA::updateEditorWindows()
{
...
void SG_SPRA::fillData(char data[32])
{
    data[1] = (char)ID;
