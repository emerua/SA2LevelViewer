...
void CCYL::loadStaticModels()
{
    ...
    loadModel(&CCYL::models, Global::dirProgRoot + "res/Models/GlobalObjects/Collision/", "Cylinder");

    if (CCYL::cmBase == nullptr)
    {
        CCYL::cmBase = loadCollisionModel(Global::dirProgRoot + "res/Models/GlobalObjects/Collision/", "Cylinder");
    }
}
